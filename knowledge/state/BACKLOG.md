...
- [x] **退役 Collection Dial（2026-08-27，ADR 0036）**：用户面、Undo RPC/列、Dial 账本与 `bulk-organize` undo 路径已删除。canonical `collection_repos` 与 relation head 保留。本机无 Docker，未跑 pgTAP / 未部署远端。见 `logs/2026-08-27-retire-collection-dial.md`。
