...
- **Collection Dial 产品退役（2026-08-27，ADR 0036）**：用户面、Undo RPC/列、Dial 账本行与 `p_item_repo_ids` 已删除。Quick Look / 批量对话框 / relation head 写入缝保留。embedding 仍服务 Related Stars 与隐形混合搜索。远端 `hqtrmulypxwdqvzlkhke` 已 apply `20260819120000` + `20260827000000`，`bulk-organize` ACTIVE v7。
...
- **ADR 0035 退役用户自定义 Tag（2026-08-19）**：cutover 已落地。远端 `hqtrmulypxwdqvzlkhke` 已于 2026-08-27 随 Dial 退役一并 apply `20260819120000`。下一 frontier 为 Phase 3 浏览器扩展；不要按「页内打标签」实现。
